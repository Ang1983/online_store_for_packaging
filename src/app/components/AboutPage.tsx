          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                премиальной упаковки для подарков.
              </p>
              <p>
                Фабрика находится в Китае и принадлежит членам одной семьи. 
                Производство было открыто  35 лет отцом семейства. 
                В настоящее время ее управляют 2 его сына и дочь, перейдя от ручного труда к полностью автоматизированным линиям. 
                Так же на фабрике есть своя фотостудия, экспериментальный цех, склады для хранения готовой продукции, отдел продаж и новых разработок.
              </p>
              <p>
