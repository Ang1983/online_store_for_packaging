        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                <strong>Дело в коробке</strong> — мы российская компания, которая специализируется на производстве
                премиальной упаковки для подарков, сотрудничая с проверенной Китайской фабрикой.
              </p>
              <p>
                Эта фабрика принадлежит членам одной семьи. 
                Производство было открыто  35 лет назад отцом семейства. 
                В настоящее время ее управляют 2 его сына и дочь, перейдя от ручного труда к полностью автоматизированным линиям. 
                Так же на фабрике есть своя фотостудия, экспериментальный цех, склады для хранения готовой продукции, а так же отдел продаж и новых разработок.
              </p>
              <p>
                Мы сами производим украшения и знаем как важна упаковка изделий: 
                которая говорит о Вашем подходе к делу, о том впечатлении, 
                которое должен испытать покупатель, получив подарок. 
              </p>
              <p>
                Начиная с упаковки, с первого впечатления Вы передаете философию своего бренда. 
                На этом нельзя экономить, но как эффективный предприниматель нужно тратить разумно. 
                Перепробовав большое количество фабрик в России,
                тратя непомерные деньги на упаковку, мы постоянно искали решение, которое сочетало бы в себе все ключевые факторы.
              </p>
              <p>
                Теперь наша миссия — помочь вам создать незабываемые моменты, предоставляя упаковку,
          ...
          <div>
            ...
            <div className="space-y-5">
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-gray-100 hover:border-secondary/50 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Говорят так не бывает, но за низкую цены – мы стремились сохранить неизменным качество упаковки
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-gray-100 hover:border-secondary/50 transition-colors">
                ...
                <div>
                  <h3 className="mb-2 text-lg">Приемлемая цена</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Честно сказать искали лучшую цену, ниже рынка от 30% и более
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-gray-100 hover:border-secondary/50 transition-colors">
                ...
                <div>
                  <h3 className="mb-2 text-lg">Адекватные сроки в любое время года</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Чтобы быть уверенными в исполнении заказа, особенно в сезон – когда в сентябре уже невозможно заказать партию до конца года
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-gray-100 hover:border-secondary/50 transition-colors">
                ...
                <div>
                  <h3 className="mb-2 text-lg">Возможность воплотить идеи</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Чтобы вы могли повлиять на то, как будет выглядеть ваша упаковка
                  </p>
                </div>
              </div>
            </div>
